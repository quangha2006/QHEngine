...
public:
	...
	const AString &                     GetDataPath() const; //W: modify to relative path when Python is the Compiler
...
private:
    ...
    AString             m_CachePath;
	AString				m_DataPath;	//W: modify to relative path when Python is the Compiler
