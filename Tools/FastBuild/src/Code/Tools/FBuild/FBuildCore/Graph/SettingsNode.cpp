...
REFLECT_NODE_BEGIN( SettingsNode, Node, MetaNone() )
	...
	REFLECT(		m_DataPath,					"DataPath",					MetaOptional() ) //W: Modify to relative path when Python is the Compiler
...
// GetDataPath
//------------------------------------------------------------------------------
const AString & SettingsNode::GetDataPath() const //W: modify to relative path when Python is the Compiler
{
	return m_DataPath;
}
