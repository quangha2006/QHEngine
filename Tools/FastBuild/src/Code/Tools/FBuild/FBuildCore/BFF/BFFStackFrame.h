...
public:
	...
	static void SetAcceptOverride(bool enable) { s_bAcceptOverride = enable; }
	static bool GetAcceptOverride() { return s_bAcceptOverride; }
...
private:
	...
	//frames can have variables which are going to overwritten
	static bool	s_bAcceptOverride;
};
